...
const App = () => {
  ...
  const [manzil, setManzil] = useState("http://backend66.loc/backend/kurslar")
  const [manzil1, setManzil1] = useState("http://backend66.loc/backend/hero")
  ...
  useEffect(() => {
    axios.get(manzil)
      .then(malumot => setKurslar(malumot.data))
  }, [])
    ...
    <div className='sayt'>
        ...
        hero.map((value) => {
          return (
            <div
              ...
              style={{
                backgroundImage: `url(${value.rasm})`,
              }}
            >
              <div className="hero-overlay"></div>
              <div className="hero-content text-neutral-content text-center">
                <div className="max-w-md">
                  <h1 className="mb-5 text-5xl font-bold">{value.nomi}</h1>
                  <p className="mb-5">
                    {value.malumot}
                  </p>
          ...
          return (
            <div className="hero bg-base-200 min-h-screen">
              <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                />
                <div>
                  <h1 className="text-5xl font-bold">{value.nomi}</h1>
                  <p className="py-6">
                    {value.malumot}
                  </p>
      ...
      <div className="flex justify-center items-center gap-[25px] flex-wrap">
...

        {
          kurslar.map((value) => {
            return (
              <div className="w-96 relative rounded-xl overflow-hidden shadow-xl ">
                <figure>
                  <img
                    src={value.rasm}
                    alt="Shoes" />
                ...
                <div className="card-body">
                  ...
                  <div className="card-actions justify-end">
                    <button className="btn btn-primary">{value.narx}</button>
                  </div>
                </div>
              </div>
            )
